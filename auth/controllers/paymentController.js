...
exports.savePaymentStatus = asyncErrorHandler(async (req, res, next) => {
  const data = req.body.data;
  const newPayment = new Payment({
    resultInfo: {
      resultStatus: data.resultInfo,
      resultCode: data.resultInfo,
      resultMsg: data.resultInfo,
    },
    txnId: data.txnId,
  ...
  try {
    ...
    console.log(error);
    return next(new ErrorHandler("Payment transaction hash isn't saved", 404));
  }
});
